...
public class SortByTest
{
    ...
    [Fact]
    public void SortBy_GivenArrayAndFunction_ThenReturnSortedList()
    {
        //Arrange
        var arr = new int[] { 2, 1, 4, 3, 5 };

        //Act
        var result = arr.SortBy(x => x);
    ...
    [Fact]
    public void SortBy_GivenArrayOfStrings_ThenReturnSortedList()
    {
        //Arrange
        var arr = new string[] { "B", "A", "D", "C", "E" };
        //Act
        var result = arr.SortBy(x => x);
        //Assert
        Assert.Equal(5, result.Count());
    ...
    [Fact]
    public void SortBy_GivenNullArray_ThenThrowArgumentNullException()
    {
        //Arrange
        int[] list = null!;
